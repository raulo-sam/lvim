...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    config = { "\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vconfig\19user.auto_save\frequire\0" },
    loaded = true,
    path = "/home/raul/.local/share/lunarvim/site/pack/packer/start/AutoSave.nvim"
  },
  Colorizer = {
    loaded = true,
  ...
  ["nvim-treesitter-angular"] = {
    loaded = true,
    path = "/home/raul/.local/share/lunarvim/site/pack/packer/start/nvim-treesitter-angular"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vconfig\19user.auto_save\frequire\0", "config", "AutoSave.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'gitsigns.nvim', 'vim-signature', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
